...
"EOR" indirect indexed, 0x51 opcode.
...
// NOLINTNEXTLINE
TEST(EORIndirectIndexedTests, ZeroAddressToLastAddress)
{
    ...
    std::array<std::uint8_t, 2> const program{0x51, 0x00};
...
// NOLINTNEXTLINE
TEST(EORIndirectIndexedTests, ZeropageWrapsAround)
{
    ...
    std::array<std::uint8_t, 2> const program{0x51, 0xff};
