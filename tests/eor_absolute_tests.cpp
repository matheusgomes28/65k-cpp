...
// NOLINTNEXTLINE
TEST(EORAbsoluteTests, GeneralTests)
{
    ...
    std::array<std::tuple<std::uint8_t, std::uint8_t, std::uint16_t, emulator::Flags>, 4> const test_cases{{
        {0b0101'0101, 0b0010'1010, 0x0000, emulator::Flags{.n = false, .z = false}},
        {0b0010'1010, 0b0101'0101, 0x00ff, emulator::Flags{.n = false, .z = false}},
        {0b1010'1010, 0b0101'0101, 0xff00, emulator::Flags{.n = true, .z = false}},
        {0b1111'1111, 0b1111'1111, 0xffff, emulator::Flags{.n = false, .z = true}},
    }};
    ...
    for (auto const& [init_acc, value, address, flags] : test_cases)
    {
        ...
        std::array<std::uint8_t, 3> const program{0x4d, lsb, hsb};
